...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-3xl font-bold text-toys-text">Categories</h1>
    <a href="{{ route('admin.categories.create') }}" class="px-6 py-2 bg-toys-btn text-white rounded-lg hover:bg-secondary transition">
        Add New Category
    </a>
</div>
